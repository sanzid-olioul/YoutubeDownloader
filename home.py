...
class HomeTab:
    ...
    def add(self):
        ...
        input_value.grid(column=1,row=1,columnspan=3,padx=10,pady=10)
        check_button = tkinter.Button(self.home_tab,text='Check',bg='#0C7075',fg='#6DA5C0',font=('Helvetica',18,'bold'),command=self.check_vidio)
        check_button.grid(column=4,row=1,padx=10,pady=10)

        download_label = tkinter.Label(self.home_tab,text='Folder:',bg='#0F969C',fg='#072E33',padx=10,pady=10,font=('Helvetica',16,'bold'))
        download_label.grid(column=0,row=2,padx=10,pady=10,sticky='WENS')

        download_folder = tkinter.Entry(self.home_tab,textvariable=self.download_directory,bg='#6DA5C0',fg='#072E33',font=('Helvetica',18),border='2',width=46,state='disabled')
        download_folder.grid(column=1,row=2,columnspan=3,padx=10,pady=10)
        ...
        download_folder_button.grid(column=4,row=2,padx=10,pady=10)
        ...
        download_button = tkinter.Button(self.home_tab,text='Download',bg='#0C7075',fg='#6DA5C0',font=('Helvetica',22,'bold'),command=self.run_pricess)
